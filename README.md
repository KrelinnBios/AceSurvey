...
<p align="center">
  <a href="https://acesurvey.pages.dev/"><img src="https://img.shields.io/badge/%E5%9C%A8%E7%BA%BF%E8%AE%BF%E9%97%AE-acesurvey.pages.dev-2f6f73?style=flat-square" alt="在线访问"></a>
...
AceSurvey 是一个面向无性恋社群的静态问卷工具，用于填写基础信息、梳理自我经验，并生成适合保存或分享的问卷卡片。页面无需注册，适合在桌面或手机浏览器中自助使用。
...
访问 <https://acesurvey.pages.dev/> 即可，无需注册或安装；推荐使用现代桌面或移动浏览器。
...
第三方资源不纳入本项目的 MIT 许可，分别适用其上游许可证和服务条款，详见 [THIRD-PARTY-NOTICES.md](./THIRD-PARTY-NOTICES.md)。
